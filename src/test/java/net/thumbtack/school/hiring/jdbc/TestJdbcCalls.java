//package net.thumbtack.school.hiring.jdbc;
//
...
//    private static final String URL = "jdbc:mysql://localhost:3306/hiring?useUnicode=yes&characterEncoding=UTF8&useSSL=false&serverTimezone=Asia/Omsk";
//
//    @BeforeClass()
